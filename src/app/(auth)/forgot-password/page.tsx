...
export default function ForgotPasswordPage() {
  ...
  const handleResetRequest = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const appUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://nanokit.io'
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              Enter your email and we&apos;ll send you a <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 font-semibold">secure link</span> to reset your password
            </p>
          </div>
        </div>
            ...
            {success ? (
              ...
              <form className="space-y-6" onSubmit={handleResetRequest}>
                ...
                <div className="pt-4 space-y-4">
                  ...
                  <Link
                    href="/login"
                    className="block w-full text-center py-3 text-slate-400 hover:text-cyan-400 transition-colors duration-300"
                  >
                    ← Back to Login
                  </Link>
                </div>
